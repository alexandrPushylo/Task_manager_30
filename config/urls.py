...
from dashboard.views import (
    show_technic_application,
    show_material_application,
    material_application_supply_view,
)
...
from dashboard.views import (
    change_status_application_today,
    change_weekend_to_workday,
    validate_application_today_view,
)
...
urlpatterns = [
    ...
    path(
        "templates_for_spec_constr_site/",
        task_desc_for_spec_constr_site_view,
        name="tasks_for_spec_constr_site",
    ),
    path(
        "calculate_all_applications/",
        calculate_all_applications,
        name="calculate_all_applications",
    ),
    path(
        "change_app_status/", change_status_application_today, name="change_app_status"
    ),
    ...
    path(
        "validate_app_today",
        validate_application_today_view,
        name="validate_application_today",
    ),
