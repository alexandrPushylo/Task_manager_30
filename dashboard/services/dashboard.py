...
#
#     if view_mode_ == Assets.ViewMode.ARCHIVE.value:
#         construction_sites = ConstructionSiteService.get_queryset(
#             foreman=foreman,
...
#         application_material = ApplicationMaterialService.get_queryset(
#             isArchive=False,
#             application_today__in=applications_today
#         )
#     else:
...
#         #   Отвергнуть заявку
#         if application_technic_id and operation == "reject":
#             ApplicationTechnicService.reject_or_accept(app_technic_id=application_technic_id)
#
#         elif application_technic_id and operation == "accept":
#             if not application_today_id:
#                 # _application_today = APP_TODAY_SERVICE.create_app_today(
...
#                 _application_today.save(update_fields=["status"])
#                 application_today_id = _application_today.id
#             Utilities.accept_app_tech_to_supply(application_technic_id, application_today_id)
#
#     count_not_checked_app_mater = ApplicationMaterialService.get_queryset(
#         application_today__status__in=Assets.SHOW_APPLICATIONS_FOR_SUPPLY_WITH_STATUSES,
#         isArchive=False,
...
#             UserService.get_object(id=foreman_id) if foreman_id else None
#         )
#
#         construction_site["application_today"] = (
#             applications_today.filter(construction_site_id=construction_site["id"])
...
#     if Utilities.is_valid_get_request(request.GET.get("driver_id")):
#         current_driver = UserService.get_object(
#             id=request.GET.get("driver_id"),
...
#     supply_technic_list = TechnicService.get_supply_technic_list()
#
#     current_technic_sheet_id_list = list(current_technic_sheet.values_list("technic__id", flat=True))
#     supply_technic_list_id_list = [s_tl.id for s_tl in supply_technic_list]
#
#     is_supply_driver = Utilities.is_supply_driver(current_technic_sheet_id_list, supply_technic_list_id_list)
#
#     applications_technic = ApplicationTechnicService.get_queryset(
#         isArchive=False,
#         isChecked=False,
