// import {MESS_STATUS_OK, MESS_STATUS_FAIL, parseResponse} from './tools'
...
// function changeTechnicSheetSelector(app_technic_id) {
//     // const tech_sheet_id = e.id.replace('technic_sheet_', '')
//     // $('#div_btn_edit_control_' + app_technic_id).show();
//     // $('#btn_options_' + app_technic_id).hide();
